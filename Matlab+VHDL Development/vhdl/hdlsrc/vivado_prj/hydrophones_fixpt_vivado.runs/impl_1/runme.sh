...
HD_PWD='C:/Users/Daniel Yang/Desktop/Good Hphones/codegen/hydrophones/hdlsrc/vivado_prj/hydrophones_fixpt_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hydrophones_fixpt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hydrophones_fixpt.tcl -notrace
