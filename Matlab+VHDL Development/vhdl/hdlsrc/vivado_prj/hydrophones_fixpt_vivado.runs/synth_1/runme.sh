...
HD_PWD='C:/Users/Daniel Yang/Desktop/Good Hphones/codegen/hydrophones/hdlsrc/vivado_prj/hydrophones_fixpt_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hydrophones_fixpt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hydrophones_fixpt.tcl
